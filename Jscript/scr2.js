        (function($,window,document,undefinen){
            $.fn.bannerSwiper=function(option){
                this.default={
                    ...
                    times:5000,//自动轮播的时间间隔,单位是毫秒
                    speed:600,//点击按钮时切换的速度
                    circle:true,//是否启动小圆点
                    circleAlign:"center",//图片底部小圆点的对其方式，left是左，right是右，center是居中
                    circleClick:true//小圆点是否可以点击
                }
                var self=this;
                this.time=null;
                ...
                this.bulid=function(){
                    ...
                    $(wrap).parent().height(512);//这个是图片高度
                    $(wrap).parent().width(1024);//这个是图片宽度
